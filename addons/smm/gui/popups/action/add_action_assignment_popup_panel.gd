...
signal add_assignment(variable_name: String, function_name: String, argument_names: Array[String])
...
func show_add(available_arguments: Array[String]) -> void:
...
func _on_add_button_pressed() -> void:
	...
	if variable_name and function_name:
		emit_signal("add_assignment", variable_name, function_name, argument_names)

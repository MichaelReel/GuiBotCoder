...
signal add_perform(item: TreeItem, state_gui: StateGui, function_name: String, argument_names: Array[String])
...
func show_add(item: TreeItem, state_gui: StateGui, available_arguments: Array[String]) -> void:
	...
	function_name_field.grab_focus()
...
func _on_add_button_pressed() -> void:
	...
	if function_name:
		emit_signal("add_perform", _item, _state_gui, function_name, argument_names)
